---
{"topic":"MachineLearning","dg-publish":true,"permalink":"/StudyNotes/Gradient Descent/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- Hyperparameter Tuning: [[StudyNotes/Hyperparameter Tuning#Hyperparameter Tuning in Deep Learning\|Hyperparameter Tuning#Hyperparameter Tuning in Deep Learning]]
- Batch Normalization: [[StudyNotes/Regularization#**batch-normalization**\|Regularization#**batch-normalization**]]
...
- SGD itself has various “upgrades” variants
	...
	- **Momentum** ([[StudyNotes/Gradient Descent#Momentum\|Gradient Descent#Momentum]]): helps accelerate SGD by orienting the gradient descent in the relevant direction and reducing oscillations
	- **RMSprop** ([[StudyNotes/Gradient Descent#RMSprop (Root Mean Square prop)\|Gradient Descent#RMSprop (Root Mean Square prop)]]) and **Adam** ([[StudyNotes/Gradient Descent#Adam (Adaptive Moment Estimation)\|Gradient Descent#Adam (Adaptive Moment Estimation)]]): frequently used in neural networks
