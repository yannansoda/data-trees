---
{"topic":"Statistics, Modeling","dg-publish":true,"permalink":"/StudyNotes/Causal inference/","dgPassFrontmatter":true,"noteIcon":""}
---
...
## Causal Graphs
[[StudyNotes/Probabilistic Graphical Models#Directed acyclic graph\|Probabilistic Graphical Models#Directed acyclic graph]]
...
2. match individuals from the control group to those in the disease group with similar scores using [[StudyNotes/K-Nearest Neighbor\|K-Nearest Neighbor]]
...
- extension: [[StudyNotes/Mendelian Randomization\|Mendelian Randomization]]
#### How it works
...
- Causal ML: estimate HTE ([[StudyNotes/Causal inference#Heterogeneous Treatment Effect (HTE)\|Causal inference#Heterogeneous Treatment Effect (HTE)]])
- classic causal inference methods: primarily estimate ATE ([[StudyNotes/Causal inference#Average Treatment Effect (ATE)\|Causal inference#Average Treatment Effect (ATE)]])
### Causal Forests
= [[StudyNotes/Decision Tree & Random Forest#Random Forest\|Decision Tree & Random Forest#Random Forest]] algorithm adapted to estimate [[StudyNotes/Causal inference#Conditional Average Treatment Effect (CATE)\|Causal inference#Conditional Average Treatment Effect (CATE)]]
#### How it works
