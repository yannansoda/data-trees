---
{"topic":"DataScience, MachineLearning","dg-publish":true,"permalink":"/StudyNotes/ML System Monitoring and Continual learning/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- data distribution shifts: [[StudyNotes/Best Practices & Common Pitfalls in Machine Learning#Data Drift & Distribution Shift\|Best Practices & Common Pitfalls in Machine Learning#Data Drift & Distribution Shift]]
- edge cases
...
- How to evaluate model's performance even before it's deployed: [[StudyNotes/Model Offline Evaluation\|Model Offline Evaluation]]
- When performance is unexpected:
	1. brainstorm the ways the system might go wrong
	2. establish metrics to assess performance against these issues on *appropriate slices of data* using [[StudyNotes/Error analysis\|Error analysis]]
## Observability 
...
>[!Link]
>The two types can be also regarded as [[StudyNotes/Model-centric vs. Data-centric AI Development\|Model-centric vs. Data-centric AI Development]]
>
...
### A/B testing ([[StudyNotes/AB testing\|AB testing]]) 
