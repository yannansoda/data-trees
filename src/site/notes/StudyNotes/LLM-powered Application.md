---
{"topic":"LargeLanguageModel","dg-publish":true,"permalink":"/StudyNotes/LLM-powered Application/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- LLM can interact with external datasets: 
	- e.g. [[StudyNotes/Retrieval Augmented Generation (RAG)\|Retrieval Augmented Generation (RAG)]]
