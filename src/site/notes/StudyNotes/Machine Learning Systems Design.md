---
{"topic":"MachineLearning","dg-publish":true,"permalink":"/StudyNotes/Machine Learning Systems Design/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- **Continual Learning**: [[StudyNotes/ML System Monitoring and Continual learning#Continual Learning\|ML System Monitoring and Continual learning#Continual Learning]]
...
- to keep track of:
	...
	- data lineage: sequence of steps applied to data ([[StudyNotes/Data Preprocessing & Feature Engineering#^96122f\|Data Preprocessing & Feature Engineering#^96122f]])
- use meta-data
...
## 4. [[StudyNotes/ML Model Deployment\|ML Model Deployment]]
## 5. [[StudyNotes/ML System Monitoring and Continual learning\|ML System Monitoring and Continual learning]]
## 6. Business analysis
...
- storage layer: where data is collected and stored
	...
	- [[StudyNotes/AWS Storage & Databases#Amazon Simple Storage Service (Amazon S3)\|AWS Storage & Databases#Amazon Simple Storage Service (Amazon S3)]], Snowflake
- compute layer: all the compute resources a company has access to and the mechanism to determine how these resources can be used
	- CPU, GPU
	- [[StudyNotes/Amazon EC2\|Amazon EC2]], GCP
