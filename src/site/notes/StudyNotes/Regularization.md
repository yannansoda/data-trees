---
{"topic":"DataScience","dg-publish":true,"permalink":"/StudyNotes/Regularization/","dgPassFrontmatter":true,"noteIcon":""}
---
...
See [[StudyNotes/Cost Functions#Cost function with regularization\|Cost Functions#Cost function with regularization]].

## Types of Techniques
### **shrinking (= add penalty/reduce weight/weight decay)**
- **L1 regularization (lasso)**: [[StudyNotes/Cost Functions#^19a2bf\|Cost Functions#^19a2bf]]
{ #6700d3}

- **L2 regularization (ridge, "weight decay"):** [[StudyNotes/Cost Functions#^b2a01f\|Cost Functions#^b2a01f]]
{ #1e9ee5}
...
- mostly used in computer vision (e.g. [[StudyNotes/Pattern Recognition\|Pattern Recognition]])
### **batch-normalization**
