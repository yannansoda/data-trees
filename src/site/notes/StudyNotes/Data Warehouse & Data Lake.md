---
{"topic":"DataEngineering","dg-publish":true,"permalink":"/StudyNotes/Data Warehouse & Data Lake/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- Data Warehouse is a specific type of [[StudyNotes/Database\|Database]] that consolidates data from multiple source systems for data consistency, accuracy, and efficient access.
- The data in the data warehouse is organized into tables, similar to a [[StudyNotes/Database\|Database]], but the tables are optimized for querying and analysis using a schema, with features such as star schemas, fact tables, and dimension tables.

## Database vs. Data Warehouse

| [[StudyNotes/Database\|Database]]                 | Data warehouse ([[StudyNotes/Data Warehouse & Data Lake#What is Data Warehouse\|Data Warehouse & Data Lake#What is Data Warehouse]]) |     |
| ---------------------------- | ---------------------------------------------------------------------- | --- |
...
>[!Important] The process from database to data warehouse is [[StudyNotes/ETL\|ETL]].
