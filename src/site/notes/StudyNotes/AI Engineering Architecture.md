---
{"topic":"LargeLanguageModel, AIEngineering","dg-publish":true,"permalink":"/StudyNotes/AI Engineering Architecture/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- via [[StudyNotes/Retrieval Augmented Generation (RAG)\|Retrieval Augmented Generation (RAG)]]
...
_Placed in a loop_: the system's output may not be enough to accomplish the task so it starts another cycle (similar to [[StudyNotes/Intelligent Agent\|Intelligent Agent]])