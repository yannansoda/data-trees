---
{"topic":"Math, Modeling","dg-publish":true,"permalink":"/StudyNotes/Convolution/","dgPassFrontmatter":true,"noteIcon":""}
---

# Convolution $\ast$
$$r(t)  = s(t) * h(t) = \int s(\tau)h(t-\tau)d\tau$$

# Convolution in [[__Index/Computational Neuroscience\|Computational Neuroscience]]:
