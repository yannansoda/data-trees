---
{"topic":"DeepLearning, LargeLanguageModel","dg-publish":true,"permalink":"/StudyNotes/Transformer/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- key innovation - "Attention is all you need (2017)": self-attention mechanism
	...
	- For example, for NLP, self-attention decides which part of a sentence influences which word, by reweighting the [[StudyNotes/Natural Language Processing#Word embeddings\|Natural Language Processing#Word embeddings]] with interactions between words.
