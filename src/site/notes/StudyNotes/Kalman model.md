---
{"topic":"Math","dg-publish":true,"permalink":"/StudyNotes/Kalman model/","dgPassFrontmatter":true,"noteIcon":""}
---


# What is Kalman Model/Filter
When the hidden variables of a [[StudyNotes/Markov Chain\|Markov Chain]] are continuous and probability distributions are Gaussians, then the model is usually called a Kalman model. 
