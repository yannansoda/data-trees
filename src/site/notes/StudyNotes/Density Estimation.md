---
{"topic":"Math","dg-publish":true,"permalink":"/StudyNotes/Density Estimation/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- Then, KDE just generalizes the **naive density estimator** by replacing the uniform density function with an arbitrary density function, **the [[StudyNotes/Kernel Function\|Kernel Function]]**.
### Parameters of KDE
- **kernel**
	- specifies the shape of the distribution placed at each point
	- kernel selection: [[StudyNotes/Kernel Function#Types of Kernels\|Kernel Function#Types of Kernels]]
- **kernel bandwidth**
