---
{"topic":"LargeLanguageModel, AIEngineering","dg-publish":true,"permalink":"/StudyNotes/LLM Finetuning/","dgPassFrontmatter":true,"noteIcon":""}
---

## What is finetuning
- it's a supervised learning process where labeled examples are used to update the weights of the LLM
- it's one way to do [[StudyNotes/Transfer Learning and Multi-task Learning#Transfer Learning\|Transfer Learning and Multi-task Learning#Transfer Learning]]
...
- additive
	...
	- methods
		...
		-  __prompt tuning__ with soft-prompts
			- note prompt tuning is different from [[StudyNotes/Prompt Engineering\|Prompt Engineering]]
...
## Finetuning vs [[StudyNotes/Retrieval Augmented Generation (RAG)\|Retrieval Augmented Generation (RAG)]]
