---
{"topic":"Math, Modeling, CompNeuro","dg-publish":true,"permalink":"/StudyNotes/Drift Diffusion Model/","dgPassFrontmatter":true,"noteIcon":""}
---

### What is drift diffusion model
- The drift diffusion model (DDM) is an extension of the [[StudyNotes/Diffusion Model\|Diffusion Model]], specifically tailored for modeling decision-making processes.
...
### Understand drift diffusion model with [[StudyNotes/Sequential Probability Ratio Test\|Sequential Probability Ratio Test]]
