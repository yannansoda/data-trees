---
{"topic":"Statistics, Modeling","dg-publish":true,"permalink":"/StudyNotes/Factor Analysis/","dgPassFrontmatter":true,"noteIcon":""}
---
...
> - In PCA ([[StudyNotes/Dimensionality Reduction#PCA vs. LDA\|Dimensionality Reduction#PCA vs. LDA]]): only one fixed outcome that orders the components from the highest explanatory value to the lowest explanatory value
