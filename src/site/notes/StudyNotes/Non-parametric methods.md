---
{"topic":"Statistics","dg-publish":true,"permalink":"/StudyNotes/Non-parametric methods/","dgPassFrontmatter":true,"noteIcon":""}
---
...
| -- | -- | -- |
| 1-sample sign test [[StudyNotes/Paired-data Tests#the sign test\|Paired-data Tests#the sign test]]| One-sample Z-test, One sample t-test | estimate the median of a population and compare it to a reference value |
