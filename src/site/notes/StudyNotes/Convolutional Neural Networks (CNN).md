---
{"topic":"MachineLearning","dg-publish":true,"permalink":"/StudyNotes/Convolutional Neural Networks (CNN)/","dgPassFrontmatter":true,"noteIcon":""}
---
...
- stride ([[StudyNotes/Convolutional Neural Networks (CNN)#Stride\|Convolutional Neural Networks (CNN)#Stride]]) = the moving step size of the feature detector: usually 2
