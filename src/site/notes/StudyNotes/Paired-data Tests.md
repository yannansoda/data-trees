---
{"topic":"Statistics","dg-publish":true,"permalink":"/StudyNotes/Paired-data Tests/","dgPassFrontmatter":true,"noteIcon":""}
---
...
Paired t-test can be used only when the difference d is **normally distributed**. This can be checked using [[StudyNotes/Normality Tests\|Normality Tests]].
