---
{"topic":"Math","dg-publish":true,"permalink":"/StudyNotes/Sequential Probability Ratio Test/","dgPassFrontmatter":true,"noteIcon":""}
---


# Sequential Probability Ratio Test
The Sequential Probability Ratio Test is a [[StudyNotes/Likelihood ratio test\|Likelihood ratio test]] for determining which of two hypotheses is more likely. It is appropriate for sequential independent and identically distributed (iid) data.
