---
{"topic":"Modeling, MachineLearning","dg-publish":true,"permalink":"/StudyNotes/Bias-Variance Tradeoff/","dgPassFrontmatter":true,"noteIcon":""}
---

Bias-Variance trade-off -> [[StudyNotes/Underfitting vs. Overfitting\|Underfitting vs. Overfitting]] issues
...
check [[StudyNotes/Cost Functions#Cost function with regularization\|Cost Functions#Cost function with regularization]] and [[StudyNotes/Regularization\|Regularization]]
...
- High bias
	...
	- try decreasing [[StudyNotes/Regularization\|Regularization]] parameter $\lambda$
- High variance
	- get more training examples
	- try smaller sets of features
	- try increasing [[StudyNotes/Regularization\|Regularization]] parameter $\lambda$
