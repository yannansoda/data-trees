---
{"topic":"Math","dg-publish":true,"permalink":"/StudyNotes/Linear Time-Invariant (LTI) systems/","dgPassFrontmatter":true,"noteIcon":""}
---
...
If $s_E(t)$ is the eigenfunction and H is the eigenvalue, there should be the [[StudyNotes/Convolution\|Convolution]]: 
$$s_E(t) * h(t) = H s_E(t)$$
then the solution is:
$$s_E(t) = e^{i\omega t} = e^{i2\pi ft} = cos(2\pi ft) + i \, sin(2\pi ft)$$

## [[StudyNotes/Correlation\|Correlation]] and LTI systems
