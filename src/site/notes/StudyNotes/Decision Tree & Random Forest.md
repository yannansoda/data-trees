---
{"topic":"MachineLearning","dg-publish":true,"permalink":"/StudyNotes/Decision Tree & Random Forest/","dgPassFrontmatter":true,"noteIcon":""}
---
...
# Random Forest
Random forest is a [[StudyNotes/Ensemble Learning\|Ensemble Learning]] method as an ensemble of Decision trees, which is necessary, because a single tree is sensitive to small changes of the data.
### How it works
