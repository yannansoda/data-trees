---
{"topic":"Statistics","dg-publish":true,"permalink":"/StudyNotes/Probability Basics/","dgPassFrontmatter":true,"noteIcon":""}
---
...
$$
> Note that [[StudyNotes/Markov Chain\|Markov Chain]] can be regarded as a simplified version of the chain rule, i.e. predict by ignoring all previous events but the last one(s), so that $p(A_n| A_1, .. A_{n-1}) \approx p(A_n | A_{n-1})$
