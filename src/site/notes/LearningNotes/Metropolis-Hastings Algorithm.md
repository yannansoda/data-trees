...
# What it is
Metropolis-Hastings Algorithm is a general framework which includes as special cases the very first and simpler MCMC [[LearningNotes/Markov chain Monte Carlo Algorithm\|Markov chain Monte Carlo Algorithm]].
