...
- **2. Data Ingestion + Feature Pipeline**
   ...
   - Common Tools:
	...
	- Feature Store: Feast, Hopsworks, Tecton,  [[LearningNotes/Amazon SageMaker\|Amazon SageMaker]] Feature Store
- **3. Model Training + Tuning**
   - Train and tune the model with reproducible tracking.
   - Common Tools:
	   - Frameworks: PyTorch, TensorFlow, JAX, Scikit-Learn, XGBoost
	   - Orchestration: Kubeflow, Airflow, MLflow, Vertex Pipelines, Azure ML, [[LearningNotes/Amazon SageMaker\|Amazon SageMaker]]
...
- **9. CI/CD + Model Lifecycle Automation**
   ...
   - Common Tools:
	   ...
	   - Automated retraining: Airflow, Kubeflow, [[LearningNotes/Amazon SageMaker\|Amazon SageMaker]] Pipelines
	   - Deployment strategies: Canary, Blue-Green, Shadow Deploy
- **10. Monitoring, Drift Detection & Maintenance**: [[LearningNotes/ML System Monitoring and Continual learning\|ML System Monitoring and Continual learning]]
...
- **Serverless** – AWS Lambda ([[LearningNotes/AWS for Data Science#^94aba2\|AWS for Data Science#^94aba2]]), Cloud Functions (low-maintenance, pay-per-request)
...
- pruning
	- originally for decision trees ([[LearningNotes/Decision Tree & Random Forest#^4c01d0\|Decision Tree & Random Forest#^4c01d0]])
