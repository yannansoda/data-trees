---
{"topic":"Math","dg-publish":true,"permalink":"/LearningNotes/Sequential Probability Ratio Test/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Math"}}
---


# Sequential Probability Ratio Test
The Sequential Probability Ratio Test is a [[LearningNotes/Likelihood ratio test\|Likelihood ratio test]] for determining which of two hypotheses is more likely. It is appropriate for sequential independent and identically distributed (iid) data.
