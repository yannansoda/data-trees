...
- The drift diffusion model (DDM) is an extension of the [[LearningNotes/Diffusion Model\|Diffusion Model]], specifically tailored for modeling decision-making processes.
...
### Understand drift diffusion model with [[LearningNotes/Sequential Probability Ratio Test\|Sequential Probability Ratio Test]]
