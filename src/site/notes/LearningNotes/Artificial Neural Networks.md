...
5. **Back-propagation**: from right to left, the error is propagated. Update the weights according to how much they are *responsible* for the error by [[LearningNotes/Gradient Descent\|Gradient Descent]].
...
6. Repeat Steps 1 to 5 and update the weights after each observation (**[[LearningNotes/Reinforcement Learning\|Reinforcement Learning]]**); OR: Repeat Steps 1 to 5 but update the weights only after a batch of observations (**Batch Learning**).
