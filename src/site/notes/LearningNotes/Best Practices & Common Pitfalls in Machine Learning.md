---
{"topic":"MachineLearning","dg-publish":true,"permalink":"/LearningNotes/Best Practices & Common Pitfalls in Machine Learning/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"MachineLearning"}}
---
...
- **Algorithm-level methods**
	- use [[LearningNotes/Ensemble Learning\|Ensemble Learning]] methods, because each model in the ensemble can be trained on a different subset of the data 
...
- efficient data labelling
	- access to additional human workforces: [[LearningNotes/Machine Learning Systems Design#Human-in-the-Loop Pipelines\|Machine Learning Systems Design#Human-in-the-Loop Pipelines]]
