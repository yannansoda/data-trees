---
{"topic":"Statistics","dg-publish":true,"permalink":"/LearningNotes/Paired-data Tests/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Statistics"}}
---
...
Paired t-test can be used only when the difference d is **normally distributed**. This can be checked using [[LearningNotes/Normality Tests\|Normality Tests]].
