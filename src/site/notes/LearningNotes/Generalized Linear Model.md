---
{"topic":"Math, Modeling","dg-publish":true,"permalink":"/LearningNotes/Generalized Linear Model/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Math, Modeling"}}
---
...
- Link: logit
- Interpretation: coefficients are changes in **log-odds**; exponentiated coefficients are odds ratio.
	- The odds ratio is the ratio of two groups' odds of some outcome:
$$
odds \ ratio = \frac{p_a}{1-p_a} /\frac{p_b}{1-p_b}
$$ 
	- Odds ratios can be derived from logistic coefficients:
$$
\beta_x = logit(p_a) - logit(p_b) = ln(odds \ ratio)
$$
...
see [[LearningNotes/Regression#\|Regression#]]
...
- [[LearningNotes/Linear Mixed Model\|Linear Mixed Model]] — mixed-effects models for continuous repeated or clustered outcomes
