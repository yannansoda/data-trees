...
= a special kind of [[LearningNotes/Probabilistic Graphical Models#Graph structure\|Probabilistic Graphical Models#Graph structure]] with:
...
- each node is conditionally independent of all its predecessors given its parents, i.e. showing Markov property ([[LearningNotes/Markov Chain#^b013c4\|Markov Chain#^b013c4]])
