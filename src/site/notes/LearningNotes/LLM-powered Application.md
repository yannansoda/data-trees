---
{"topic":"LargeLanguageModel","dg-publish":true,"permalink":"/LearningNotes/LLM-powered Application/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"LargeLanguageModel"}}
---
...
- LLM can interact with external datasets: 
	- e.g. [[LearningNotes/Retrieval Augmented Generation (RAG)\|Retrieval Augmented Generation (RAG)]]
