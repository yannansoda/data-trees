...
- decision-making 
	...
	- also see [[LearningNotes/Drift Diffusion Model#in cognitive science\|Drift Diffusion Model#in cognitive science]]
#### in deep learning/AI
...
The [[LearningNotes/Drift Diffusion Model\|Drift Diffusion Model]] is an extension of the diffusion model, specifically tailored for modeling decision-making processes and with a drift component to the diffusion process. 
