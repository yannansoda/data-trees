---
{"topic":"Statistics","dg-publish":true,"permalink":"/LearningNotes/Circular Statistics/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Statistics"}}
---
...
=> Non-Parametric test (for linear data see [[LearningNotes/Non-parametric methods\|Non-parametric methods]]):
	- __Omnibus test__
	- __Rao's test__
...
| non-parametric paired-test (on median!!!) | Kruskal-Wallis test[[LearningNotes/Non-parametric methods#Non-parametric methods\|Non-parametric methods#Non-parametric methods]] | no prerequisites for the distribution |
