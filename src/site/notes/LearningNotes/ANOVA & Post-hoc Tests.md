...
| Same subjects/items measured in 3+ conditions or time points                   | **Repeated-measures ANOVA**         | Compare reaction time at baseline, week 1, week 4.                   | - Assumed **sphericity** : variances of the differences between all pairs of repeated conditions are equal<br>- Tested using **Mauchly's test of sphericity**<br>- If violated, use corrections such as **Greenhouse–Geisser** or **Huynh–Feldt**, or consider [[LearningNotes/Linear Mixed Model\|Linear Mixed Model]]. |
...
| Repeated measures with missing/unbalanced data, nested data, or random effects | [[LearningNotes/Linear Mixed Model\|Linear Mixed Model]]             | Trials nested within participants; participants nested within sites. |                                                                                                                                                                                                                                                                                         |

> [!tip] Practical rule
> If your design is unbalanced, hierarchical, has missing repeated measurements, or has subject/item-level random effects, a [[LearningNotes/Linear Mixed Model\|linear mixed model]] is often more flexible than classical ANOVA.
