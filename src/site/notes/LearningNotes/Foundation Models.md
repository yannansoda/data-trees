---
{"topic":"LargeLanguageModel, AIEngineering","dg-publish":true,"permalink":"/LearningNotes/Foundation Models/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"LargeLanguageModel, AIEngineering"}}
---


## Basics & Terms
### Model architecture: [[LearningNotes/Transformer\|Transformer]] 
### Model scale
...
- given a compute budget, the optimal number of parameters and number of tokens can be determined with [[LearningNotes/Scaling Law\|Scaling Law]] 
...
- Two steps
	...
	2. **Preference finetuning**: further finetune the model to output responses that align with human preference, e.g. by [[LearningNotes/Reinforcement learning with human feedback (RLHF)\|Reinforcement learning with human feedback (RLHF)]]
...
{ #27bdb5}
	...
	- affect the randomness of the output of the softmax layer in [[LearningNotes/Transformer\|Transformer]]
