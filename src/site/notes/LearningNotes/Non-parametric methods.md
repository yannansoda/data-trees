---
{"topic":"Statistics","dg-publish":true,"permalink":"/LearningNotes/Non-parametric methods/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Statistics"}}
---
...
| -- | -- | -- |
| 1-sample sign test [[LearningNotes/Paired-data Tests#the sign test\|Paired-data Tests#the sign test]]| One-sample Z-test, One sample t-test | estimate the median of a population and compare it to a reference value |
