...
- correspondingly, you will have training error, cross validation error, and test error (i.e. [[LearningNotes/Cost Functions\|Cost Functions]] without regularization terms)
