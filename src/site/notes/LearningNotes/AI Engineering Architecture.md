...
- via [[LearningNotes/Retrieval Augmented Generation (RAG)\|Retrieval Augmented Generation (RAG)]]
...
_Placed in a loop_: the system's output may not be enough to accomplish the task so it starts another cycle (similar to [[LearningNotes/Intelligent Agent\|Intelligent Agent]])