---
{"topic":"Statistics","dg-publish":true,"permalink":"/LearningNotes/Anova & Post-hoc/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Statistics"}}
---


## ANOVA
## Basics
- ANOVA is a special case of [[LearningNotes/Linear mixed models\|Linear mixed models]]: it assumes the data are idd and continuous, while generalized linear mixed models do not.
...
- the population is normal
	<= can be tested using [[LearningNotes/Normality Tests\|Normality Tests]]
- the groups have equal variance
	<= can be tested by **Levene's [[LearningNotes/Test for Equality of Variances\|Test for Equality of Variances]]**
