...
- Bidirectional RNN: 
	...
	- helpful in [[LearningNotes/Natural Language Processing\|Natural Language Processing]]
...
- Cons: inefficient, gradient vanishing/exploding
	- [[LearningNotes/Transformer\|Transformer]] may work as a better alternative
