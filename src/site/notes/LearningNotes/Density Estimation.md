---
{"topic":"Math","dg-publish":true,"permalink":"/LearningNotes/Density Estimation/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Math"}}
---
...
- Then, KDE just generalizes the **naive density estimator** by replacing the uniform density function with an arbitrary density function, **the [[LearningNotes/Kernel Function\|Kernel Function]]**.
### Parameters of KDE
- **kernel**
	- specifies the shape of the distribution placed at each point
	- kernel selection: [[LearningNotes/Kernel Function#Types of Kernels\|Kernel Function#Types of Kernels]]
- **kernel bandwidth**
