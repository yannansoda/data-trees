...
- Mean Absolute Error (MAE)
	...
	- Be careful about MAE. Compared to MSE, it does not penalize large errors. But if your loss ([[LearningNotes/Cost Functions\|Cost Functions]]) is just proportional to the size of error, then maybe MAE is better.
...
- R-squared (R^2): 
	...
	- [[LearningNotes/Regression#R-Squared coefficient of determination\|Regression#R-Squared coefficient of determination]]

# Classification Metrics
>[!Source]
>See [[LearningNotes/Confusion Matrix#Performance measures\|Confusion Matrix#Performance measures]]
- Accuracy
...
- ROC curve
	- [[LearningNotes/Confusion Matrix#Receiver Operating Characteristic (ROC)\|Confusion Matrix#Receiver Operating Characteristic (ROC)]]
