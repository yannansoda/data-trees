...
- it's one way to do [[LearningNotes/Transfer Learning and Multi-task Learning#Transfer Learning\|Transfer Learning and Multi-task Learning#Transfer Learning]]
...
- additive
	...
	- methods
		...
		-  __prompt tuning__ with soft-prompts
			- note prompt tuning is different from [[LearningNotes/Prompt Engineering\|Prompt Engineering]]
...
## Finetuning vs [[LearningNotes/Retrieval Augmented Generation (RAG)\|Retrieval Augmented Generation (RAG)]]
