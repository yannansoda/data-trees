...
- word tokenization
- subword tokenization (BPE, WordPiece): used by modern [[LearningNotes/Transformer\|Transformer]]
...
- context sensitive: a word's meaning depends on surrounding context
	- modern NLP
	- examples: BERT and other [[LearningNotes/Transformer\|Transformer]] models
{ #ff7c47}
