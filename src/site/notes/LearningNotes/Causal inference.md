...
## Causal Graphs
[[LearningNotes/Probabilistic Graphical Models#Directed acyclic graph\|Probabilistic Graphical Models#Directed acyclic graph]]
...
2. match individuals from the control group to those in the disease group with similar scores using [[LearningNotes/K-Nearest Neighbor\|K-Nearest Neighbor]]
...
- extension: [[LearningNotes/Mendelian Randomization\|Mendelian Randomization]]
#### How it works
...
- Causal ML: estimate HTE ([[LearningNotes/Causal inference#Heterogeneous Treatment Effect (HTE)\|Causal inference#Heterogeneous Treatment Effect (HTE)]])
- classic causal inference methods: primarily estimate ATE ([[LearningNotes/Causal inference#Average Treatment Effect (ATE)\|Causal inference#Average Treatment Effect (ATE)]])
### Causal Forests
= [[LearningNotes/Decision Tree & Random Forest#Random Forest\|Decision Tree & Random Forest#Random Forest]] algorithm adapted to estimate [[LearningNotes/Causal inference#Conditional Average Treatment Effect (CATE)\|Causal inference#Conditional Average Treatment Effect (CATE)]]
#### How it works
