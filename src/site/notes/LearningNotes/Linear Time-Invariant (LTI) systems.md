---
{"topic":"Math","dg-publish":true,"permalink":"/LearningNotes/Linear Time-Invariant (LTI) systems/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Math"}}
---
...
If $s_E(t)$ is the eigenfunction and H is the eigenvalue, there should be the [[LearningNotes/Convolution\|Convolution]]: 
$$s_E(t) * h(t) = H s_E(t)$$
then the solution is:
$$s_E(t) = e^{i\omega t} = e^{i2\pi ft} = cos(2\pi ft) + i \, sin(2\pi ft)$$

## [[LearningNotes/Correlation\|Correlation]] and LTI systems
