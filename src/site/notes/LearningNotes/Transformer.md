---
{"topic":"DeepLearning, LargeLanguageModel","dg-publish":true,"permalink":"/LearningNotes/Transformer/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"DeepLearning, LargeLanguageModel"}}
---
...
- key innovation - "Attention is all you need (2017)": self-attention mechanism
	...
	- For example, for NLP, self-attention decides which part of a sentence influences which word, by reweighting the [[LearningNotes/Natural Language Processing#Word embeddings\|Natural Language Processing#Word embeddings]] with interactions between words.
