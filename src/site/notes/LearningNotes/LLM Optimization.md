...
- pruning methods
	...
	- PEFT/LoRA ([[LearningNotes/LLM Finetuning#PEFT techniques\|LLM Finetuning#PEFT techniques]])
	- Post-training ([[LearningNotes/Foundation Models#Post-training\|Foundation Models#Post-training]])
