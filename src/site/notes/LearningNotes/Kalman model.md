---
{"topic":"Math","dg-publish":true,"permalink":"/LearningNotes/Kalman model/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Math"}}
---


# What is Kalman Model/Filter
When the hidden variables of a [[LearningNotes/Markov Chain\|Markov Chain]] are continuous and probability distributions are Gaussians, then the model is usually called a Kalman model. 
