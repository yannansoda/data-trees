...
### PCA
- see [[LearningNotes/Dimensionality Reduction#**PCA** vs. **LDA**\|Dimensionality Reduction#**PCA** vs. **LDA**]]
...
- Isolation Forest
- [[LearningNotes/Autoencoders\|Autoencoders]] (reconstruction error)
...
- False Positive (FP)
- Precision, Recall
- F1-score (see [[LearningNotes/Confusion Matrix#F1-score\|Confusion Matrix#F1-score]])
