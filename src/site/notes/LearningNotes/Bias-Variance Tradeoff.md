---
{"topic":"Modeling, MachineLearning","dg-publish":true,"permalink":"/LearningNotes/Bias-Variance Tradeoff/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"Modeling, MachineLearning"}}
---

Bias-Variance trade-off -> [[LearningNotes/Underfitting vs. Overfitting\|Underfitting vs. Overfitting]] issues
...
check [[LearningNotes/Cost Functions#Cost function with regularization\|Cost Functions#Cost function with regularization]] and [[LearningNotes/Regularization\|Regularization]]
...
- High bias
	...
	- try decreasing [[LearningNotes/Regularization\|Regularization]] parameter $\lambda$
- High variance
	- get more training examples
	- try smaller sets of features
	- try increasing [[LearningNotes/Regularization\|Regularization]] parameter $\lambda$
