...
### What is LSTM
- It is a type of [[LearningNotes/Recurrent Neural Networks (RNN)\|Recurrent Neural Networks (RNN)]] architecture
- It is designed to address the vanishing/exploding gradient problem (see [[LearningNotes/Optimization Algorithms#^4a1546\|Optimization Algorithms#^4a1546]]) in traditional RNNs, allowing it to effectively capture long-term dependencies in sequential data.
