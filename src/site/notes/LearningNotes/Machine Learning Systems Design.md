---
{"topic":"MachineLearning","dg-publish":true,"permalink":"/LearningNotes/Machine Learning Systems Design/","dgPassFrontmatter":true,"noteIcon":"","dg-note-properties":{"topic":"MachineLearning"}}
---
...
- **Continual Learning**: [[LearningNotes/ML System Monitoring and Continual learning#Continual Learning\|ML System Monitoring and Continual learning#Continual Learning]]
...
- to keep track of:
	...
	- data lineage: sequence of steps applied to data ([[LearningNotes/Data Preprocessing & Feature Engineering#^96122f\|Data Preprocessing & Feature Engineering#^96122f]])
- use meta-data
...
## 4. [[LearningNotes/ML Model Deployment\|ML Model Deployment]]
## 5. [[LearningNotes/ML System Monitoring and Continual learning\|ML System Monitoring and Continual learning]]
## 6. Business analysis
...
- storage layer: where data is collected and stored
	...
	- [[LearningNotes/AWS Storage & Databases#Amazon Simple Storage Service (Amazon S3)\|AWS Storage & Databases#Amazon Simple Storage Service (Amazon S3)]], Snowflake
- compute layer: all the compute resources a company has access to and the mechanism to determine how these resources can be used
	- CPU, GPU
	- [[LearningNotes/Amazon EC2\|Amazon EC2]], GCP
